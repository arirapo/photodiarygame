...
const ghostImage = document.getElementById("ghost-base-image");
...
async function loadInstallation() {
  try {
    ...
    const randomGhost = pickRandomItem(allActive);
    if (randomGhost && randomGhost.imageUrl) {
      ghostImage.src = randomGhost.imageUrl;
    }
